...
class Trucker extends StatefulWidget {
  final int clientId;
  Trucker({Key key, this.clientId}) : super(key: key);

  @override
  _TruckerState createState() => _TruckerState();
}

class _TruckerState extends State<Trucker> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Jitenge - Truck Drivers'),
        centerTitle: true,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 10.0),
            Text(
              'You are logged in as a health care provider. Please search for a truck driver below to help in reporting their daily follow up by entering their registered phone number',
              style: TextStyle(
                              ...
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: FloatingActionButton.extended(
                                      ...
                                      label: Text('Register New Truck Driver')),
                                )
                              ],
                            );
                          }
